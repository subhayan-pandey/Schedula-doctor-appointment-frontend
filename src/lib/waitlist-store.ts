        ...
        createPatientNotification(
          {
            ...
            message:
              `A slot is now available on ${matchingSlot.date} at ${matchingSlot.time}. Open the doctor booking page to book it.`,
